...
<div class="csf-welcome csf-welcome-wrap">
    ...
    <p class="csf-demo-button"><a href="<?php echo add_query_arg( array( 'csf-demo' => $status ) ); ?>"
                                  class="button button-primary<?php echo $class; ?>"><?php echo $text; ?> Demo</a></p>
    ...
    <h2 class="nav-tab-wrapper wp-clearfix">
		...
		foreach ( $links as $key => $link ) {
			...
			echo '<a href="' . add_query_arg( array( 'page'    => 'csf-welcome',
			                                         'section' => $key
				), admin_url( 'tools.php' ) ) . '" class="nav-tab' . $activate . '">' . $link . '</a>';
