...
<div class="csf-welcome-cols">
    ...
    <div class="csf--col csf--col-first">
        <span class="csf--icon csf--<?php echo( CSF::$premium ? 'active' : 'deactive' ); ?>"><i
                    class="fa fa-<?php echo( CSF::$premium ? 'check' : 'times' ); ?>"></i></span>
	...
	<?php if ( ! CSF::$premium ) { ?>
        ...
        <div class="csf--col-upgrade">
            <a href="http://codestarframework.com/" class="button button-primary" target="_blank" rel="nofollow"><i
                        class="fa fa-share"></i> Upgrade Premium Version</a>
        </div>
	<?php } ?>
